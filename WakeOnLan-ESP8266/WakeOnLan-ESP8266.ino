...
char ssid[] = "No puedes entrar";         // your network SSID (name)
char password[] = "P81M40A21H"; // your network password


// Get from the "botFather" on telegram
#define TELEGRAM_BOT_TOKEN "5835553882:AAE-H9rP1PtvVesmpwkawBpMSS9jXLQhimE"
...
targetDevice devices[] ={
  {{ 0xFC, 0x44, 0x82, 0x2A, 0x1E, 0xD0 }, "PC"}, //FC-44-82-2A-1E-D0
  {{ 0x94, 0x08, 0x53, 0x16, 0x80, 0x8F }, "TV"} //94:08:53:16:80:8F
};
